                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-border-all"></i><span>Quản lý thông tin</span></a>
                    <ul class="sub-menu">
                      ...
                      <li  class="active"><a href="{{URL::to('/shop')}}">Khu mua sắm</a>
                      </li>
                  ...
                  <table class="table">
                    ...
                    @foreach($shop as $key => $shop)
                      <tr>
                        ...
                        <td class="actions"><a class="icon" onclick="return confirm('Bạn có chắc là muốn xóa không?')" href="{{URL::to('/delete-shop/'.$shop->id)}}"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
                      </tr>
                      @endforeach
                    </tbody>
