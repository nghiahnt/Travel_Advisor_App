  ...
  <body>
    <div class="be-wrapper">
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Thêm thông tin</span></a>
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="{{URL::to('/addfun')}}">Thêm khu vui chơi</a>
                      </li>
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Thêm khu vui chơi</h2>
            ...
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                ...
                <?php
                            ...
                            ?>
                <div class="card-body">
                  <form action="{{URL::to('/insert-fun')}}" method="post" >
                     {{ csrf_field() }}
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Tên khu vui chơi</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="text" name="title" required="" placeholder="Điền khu vui chơi">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <textarea class="form-control" required="" name="content" data-parsley-minlength="30000" placeholder="Nhập nội dung"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
