    ...
    <div class="be-wrapper">
      <nav class="navbar navbar-expand fixed-top be-top-header">
        <div class="container-fluid">
          <div class="be-navbar-header"><a style="line-height: 60px;
                                                  height: 60px;
                                                  width: 220px;
                                                  ...
                                                  padding: 0 20px;
                                                  margin: 0;
                                                  display: block;" href="index.html"></a>
          </div>
          <div class="page-title"><span>Quản lý thông tin</span></div>
            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Thêm thông tin</span></a>
                    <ul class="sub-menu">
                      <li ><a href="{{URL::to('/addplace')}}">Thêm điểm đến</a>
                      </li>
                      <li ><a href="{{URL::to('/addfood')}}">Thêm món ăn</a>
                      </li>
                      <li class="active"><a href="{{URL::to('/addres')}}">Thêm nhà hàng</a>
                      </li>
                      <li><a href="{{URL::to('/addhotel')}}">Thêm khách sạn</a>
                      </li>
                      <li><a href="{{URL::to('/addfun')}}">Thêm khu vui chơi</a>
                      </li>
                      <li><a href="{{URL::to('/addshop')}}">Thêm khu mua sắm</a>
                      </li>
                      <li><a href="{{URL::to('/addhomestay')}}">Thêm homestay</a>
                      </li>
                    </ul>
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-border-all"></i><span>Quản lý thông tin</span></a>
                    <ul class="sub-menu">
                      <li ><a href="{{URL::to('/table')}}">Tất cả thông tin</a>
                      </li>
                      <li><a href="{{URL::to('/place')}}">Điểm đến</a>
                      </li>
                      <li><a href="{{URL::to('/food')}}">Món ăn</a>
                      </li>
                      <li><a href="{{URL::to('/hotel')}}">Khách sạn</a>
                      </li>
                      <li><a href="{{URL::to('/res')}}">Nhà hàng</a>
                      </li>
                      <li ><a href="{{URL::to('/fun')}}">Khu vui chơi</a>
                      </li>
                      <li><a href="{{URL::to('/shop')}}">Khu mua sắm</a>
                      </li>
                      <li><a href="{{URL::to('/home')}}">Homestay</a>
                      </li>
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Thêm nhà hàng</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Điền thông tin<span class="card-subtitle">Vui lòng điền đúng kiểu dữ liệu</span></div>
                <?php
                            $message = Session::get('message');
                            if($message){
                                echo '<h1 style="font-size: 22px, font-weight: bold, paddingnleft : 20px">'.$message.'</h1>';
                                Session::put('message',null);
                            }
                            ?>
                <div class="card-body">
                  <form action="{{URL::to('/insert-res')}}" method="post" >
                     {{ csrf_field() }}
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Tên nhà hàng</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="text" name="title" required="" placeholder="Điền tên nhà hàng">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Địa chỉ</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="text" required="" name="place" placeholder="Điền địa chỉ">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Hình ảnh</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="text" required="" name="image" placeholder="Điền URL hình ảnh">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Nội dung chính</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <textarea class="form-control" required="" name="content" data-parsley-minlength="360" placeholder="Không quá 360 kí tự"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Toàn bộ nội dung</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <textarea class="form-control" required="" name="bigcontent" data-parsley-minlength="30000" placeholder="Nhập nội dung"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Giá</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="text" required="" name="price" placeholder="Giá tiền trung bình">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Giờ mở cửa</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="text" required="" name="time" placeholder="Điền giờ mở cửa">
                      </div>
                    </div>
                    <div class="form-group row text-right">
                      <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                        <button class="btn btn-space btn-primary" type="submit">Thêm</button>
                      </div>
                    </div>
                  </form>
                </div>
