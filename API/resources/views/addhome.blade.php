  ...
  <body>
    <div class="be-wrapper">
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Thêm thông tin</span></a>
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="{{URL::to('/addhomestay')}}">Thêm homestay</a>
                      </li>
                    </ul>
                  </li>
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Thêm Homestay</h2>
            ...
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                ...
                <?php
                            ...
                            ?>
                <div class="card-body">
                  <form action="{{URL::to('/insert-home')}}" method="post" >
                     {{ csrf_field() }}
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Tên Homestay</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="text" name="title" required="" placeholder="Điền tên homestay">
                      </div>
                    </div>
                    <div class="form-group row">
