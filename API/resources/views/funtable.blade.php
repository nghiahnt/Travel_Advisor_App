                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-border-all"></i><span>Quản lý thông tin</span></a>
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="{{URL::to('/fun')}}">Khu vui chơi</a>
                      </li>
                  ...
                  <table class="table">
                    ...
                    @foreach($fun as $key => $fun)
                      <tr>
                        ...
                        <td>{{$fun->price}}</td>
                        <td>{{$fun->time}}</td>
                        <td class="actions"><a class="icon" onclick="return confirm('Bạn có chắc là muốn xóa không?')" href="{{URL::to('/delete-fun/'.$fun->id)}}"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
