                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-border-all"></i><span>Quản lý thông tin</span></a>
                    <ul class="sub-menu">
                      ...
                      <li class="active"><a href="{{URL::to('/food')}}">Món ăn</a>
                      </li>
                  ...
                  <table class="table">
                    ...
                    @foreach($food as $key => $food)
                      <tr>
                        ...
                        <td>{{$food->place}}</td>
                        <td>{{$food->content}}</td>
                        <td class="actions"><a class="icon" onclick="return confirm('Bạn có chắc là muốn xóa không?')" href="{{URL::to('/delete-food/'.$food->id)}}"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
