  ...
  <body>
    <div class="be-wrapper">
              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-border-all"></i><span>Quản lý thông tin</span></a>
                    <ul class="sub-menu">
                      <li class="active"><a href="{{URL::to('/table')}}">Tất cả thông tin</a>
                      </li>
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Tất cả thông tin</h2>
        ...
        <div class="main-content container-fluid">
          ...
          <div  style= "-webkit-box-flex: 0; flex: 0 0 100, max-width: 100%;">
              <div class="card card-table">
                <div class="card-header">Món ăn
                ...
                <div class="card-body">
                  <table class="table">
                    ...
                    @foreach($food as $key => $food)
                      <tr>
                        <td>{{$food->title}}</td>
                        <td><img src="{{ $food->image }}" width= "340px" height= "200px "></td>
                        <td>{{$food->place}}</td>
                        <td>{{$food->content}}</td>
            ...
            <div style= "-webkit-box-flex: 0; flex: 0 0 100, max-width: 100%;">
              <div class="card card-table">
                <div class="card-header">Điểm đến
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
                ...
                <div class="card-body">
                  <table class="table">
                    <thead>
                      <tr>
                        <th style="width:10%;">Tên địa điểm</th>
                        <th style="width:25%;">Hình ảnh</th>
                        <th style="width:15%;">Địa chỉ</th>
                        <th style="width:50%;">Nội dung</th>
                        <th class="actions"></th>
                    ...
                    @foreach($place as $key => $place)
                      <tr>
                        <td>{{$place->title}}</td>
                        <td><img src="{{ $place->image }}" width= "340px" height= "200px "></td>
                        <td>{{$place->place}}</td>
                        <td>{{$place->content}}</td>
                        <td class="actions"><a class="icon" href="#"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
            ...
            <div style= "-webkit-box-flex: 0; flex: 0 0 100, max-width: 100%;">
              <div class="card card-table">
                <div class="card-header">Khu vui chơi
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th style="width:10%;">Giờ mở cửa</th>
                        <th class="actions"></th>
                      </tr>
                    </thead>
                    <tbody>
                    @foreach($fun as $key => $fun)
                      <tr>
                        <td>{{$fun->title}}</td>
                        <td><img src="{{ $fun->image }}" width= "340px" height= "200px "></td>
                        <td>{{$fun->place}}</td>
                        <td>{{$fun->content}}</td>
                        <td>{{$fun->price}}</td>
                        <td>{{$fun->time}}</td>
            ...
            <div  style= "-webkit-box-flex: 0; flex: 0 0 100, max-width: 100%;">
              <div class="card card-table">
                <div class="card-header">Khách sạn
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
                ...
                <div class="card-body">
                  <table class="table">
                    <thead>
                      <tr>
                        <th style="width:10%;">Tên khách sạn</th>
                        <th style="width:25%;">Hình ảnh</th>
                        <th style="width:15%;">Địa chỉ</th>
                    ...
                    @foreach($hotel as $key => $hotel)
                      <tr>
                        <td>{{$hotel->title}}</td>
                        <td><img src="{{ $hotel->image }}" width= "340px" height= "200px "></td>
                        <td>{{$hotel->place}}</td>
                        <td>{{$hotel->bigcontent}}</td>
                        <td>{{$hotel->price}}</td>
                        <td class="actions"><a class="icon" href="#"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
                      @endforeach
            ...
            <div  style= "-webkit-box-flex: 0; flex: 0 0 100, max-width: 100%;">
              <div class="card card-table">
                <div class="card-header">HomeStay
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
                ...
                <div class="card-body">
                  <table class="table">
                    <thead>
                      <tr>
                        <th style="width:10%;">Tên Homestay</th>
                        <th style="width:25%;">Hình ảnh</th>
                        <th style="width:15%;">Địa chỉ</th>
                        <th style="width:45%;">Nội dung</th>
                        <th style="width:5%;">Giá</th>
                    ...
                    @foreach($homestay as $key => $homestay)
                      <tr>
                        ...
                        <td><img src="{{ $homestay->image }}" width= "340px" height= "200px "></td>
                        <td>{{$homestay->place}}</td>
                        <td>{{$homestay->content}}</td>
            ...
            <div  style= "-webkit-box-flex: 0; flex: 0 0 100, max-width: 100%;">
              <div class="card card-table">
                <div class="card-header">Nhà hàng
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
                ...
                <div class="card-body">
                  <table class="table">
                    <thead>
                      <tr>
                        <th style="width:8%;">Tên nhà hàng</th>
                        <th style="width:25%;">Hình ảnh</th>
                        <th style="width:12%;">Địa chỉ</th>
                        <th style="width:45%;">Nội dung</th>
                        <td style="width:5%">Giá</td>
                        <td style="width: 5%">Giờ mở cửa</td>
                        <th class="actions"></th>
                      </tr>
                    </thead>
                    <tbody>
                    @foreach($res as $key => $res)
                      <tr>
                        <td>{{$res->title}}</td>
                        <td><img src="{{ $res->image }}" width= "340px" height= "200px "></td>
                        <td>{{$res->place}}</td>
                        <td>{{$res->content}}</td>
                        <td>{{$res->price}}</td>
                        <td>{{$res->time}}</td>
            ...
            <div  style= "-webkit-box-flex: 0; flex: 0 0 100, max-width: 100%;">
              <div class="card card-table">
                <div class="card-header">Khu mua sắm
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
                ...
                <div class="card-body">
                  <table class="table">
                    ...
                    @foreach($shop as $key => $shop)
                      <tr>
                        <td>{{$shop->title}}</td>
                        <td><img src="{{ $shop->image }}" width= "340px" height= "200px "></td>
                        <td>{{$shop->place}}</td>
                        <td>{{$shop->bigcontent}}</td>
                        <td class="actions"><a class="icon" href="#"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
                      @endforeach
                    </tbody>
