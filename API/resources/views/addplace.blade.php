  ...
  <body>
    <div class="be-wrapper">
              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Thêm thông tin</span></a>
                    <ul class="sub-menu">
                      <li class="active"><a href="{{URL::to('/addplace')}}">Thêm điểm đến</a>
                      </li>
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Thêm điểm đến</h2>
            ...
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                ...
                <?php
                            ...
                            if($message){
                                echo '<span style="font-size: 22, font-weight: bold, marginleft : 20px">'.$message.'</span>';
                                Session::put('message',null);
                            }
                            ?>
                <div class="card-body">
                  <form action="{{URL::to('/insert-place')}}" method="post" >
                     {{ csrf_field() }}
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Tên điểm đến</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="text" name="title" required="" placeholder="Điền tên điểm đến">
                      </div>
                    </div>
                    <div class="form-group row">
