...
class AdminController extends Controller
{
    ...
    public function table(){
            ...
            return view('admintable')->with('food',$food)->with('place',$place)->with('shop',$shop)->with('fun',$fun)->with('customer',$customer)->with('homestay',$homestay)->with('hotel',$hotel)->with('res',$res);
        }
    ...
    public function deletehotel ($id, Request $req){
        try { 
            ...
            if($hotel!=null){
                $hotel->delete();
                Session::put('message','Xóa khách sạnthành công');
